...
![Testing on Device](/graphics/course-banners/mobile-wallet-adapter.png)

MWA only works on physical Android devices. There's no simulator support—the protocol relies on intents, local sockets, and a real wallet app. This lesson covers everything you need to debug and test your dApp on hardware.
...
**iOS Note**: MWA is Android-only as of writing. iOS dApps use deeplinks or web-based wallet adapters instead.
