...
![Mobile Wallet Adapter](/graphics/course-banners/mobile-wallet-adapter.png)
...
<ArticleSection name="What We're Building" id="what-were-building" level="h2" />
...
The code examples use real patterns from production apps—not simplified demos that break in edge cases. You'll learn not just *how* to use MWA, but *why* it works the way it does.
