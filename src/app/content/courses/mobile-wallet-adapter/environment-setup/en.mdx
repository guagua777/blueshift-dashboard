...
![Environment Setup](/graphics/course-banners/mobile-wallet-adapter.png)
...
Getting Solana development working in React Native requires some careful setup. The Solana JavaScript libraries assume a Node.js environment with crypto APIs that don't exist in React Native. We need to provide polyfills—shims that implement these missing APIs.
...
The development build installs on your device and connects to Metro for live reload—similar to Expo Go, but with native module support.
...
Similar cause—Buffer polyfill not available globally. Ensure:
...
You can develop UI and non-MWA features in an Android emulator. However, testing actual wallet connections requires either:
...
**Note:** iOS support for MWA is limited and wallet-dependent. As of this writing, focus on Android development. Check the [Solana Mobile documentation](https://docs.solanamobile.com) for iOS updates.
